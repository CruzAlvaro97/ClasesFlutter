...
import 'package:flutter_ejemplo_1/Sesion%207/Widgets/plantillascreen.dart';
import 'package:tiktoklikescroller/tiktoklikescroller.dart';

class ScreenScroller7 extends StatefulWidget {
  const ScreenScroller7({super.key});

  @override
  State<ScreenScroller7> createState() => _ScreenScroller7State();
}

class _ScreenScroller7State extends State<ScreenScroller7> {
